...
import 'package:AYT_Attendence/Screens/Reporter%20Pages/ReporterList.dart';
...
import 'EarlyCheckOutRequest.dart';
import 'GeneralLeaves.dart';
import 'SalaryList.dart';
import 'dashboard.dart';
import 'myaccountspage.dart';
import 'trackattendance.dart';
  ...
  getLoggedInState() async {
    await HelperFunctions2.getUserLoggedInSharedPreference().then((value){
      setState(() {
        ...
        print("userIsLoggedIn----->"+userIsLoggedIn.toString());
      });
    });
  }
            ...
            child: ListView(
              children: [
                ...
                ListTile(
                  onTap: () {
                    print("Tapped Chat");
                    print("Tapped Chat"+userIsLoggedIn.toString());
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => userIsLoggedIn == true
                            ? ChatRoom()
                            : BottomNavBar(),
                      ),
                    );
                ...
                ListTile(
                  onTap: () {
                    debugPrint("Tapped Reporter");
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ReporterList(),
                      ),
                    );
                  },
                  leading: Icon(

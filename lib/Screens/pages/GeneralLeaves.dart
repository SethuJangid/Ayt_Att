                      ...
                      if (snapshot.hasData) {
                        return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              //var date = DateTime.parse(article.leaveDate);
                              print("check--> "+article.leaveDate);
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Text(article.leaveDate.toString(),style: TextStyle(fontSize: 17,color: Colors.black54,fontWeight: FontWeight.w400),textAlign: TextAlign.center,),
                                          Padding(padding:  EdgeInsets.all(8.0)),
                                          Divider(
                                            height: 1,
                                            color: Colors.black38,
